...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Germaine23',
      password: '92sc7xm1FW1Nv3c',
      email: 'Colton_Sawayn3@hotmail.com',
      name: 'Kenneth Cummings',
      userType: 100,
      mobileNo: '(236) 662-8165',
      resetPasswordLink: {},
      loginRetryLimit: 2,
      loginReactiveTime: '2023-02-03T12:11:42.356Z',
      id: '63450901b7c13e6f838a4170'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Wilma_Quigley',
        'password':'3aJLSGm_TuDqlyi',
        'email':'Pietro35@yahoo.com',
        'name':'Shaun Hauck DDS',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(932) 634-6144',
